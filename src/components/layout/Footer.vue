  ...
  <footer class="bg-gray-900 text-white">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="space-y-4">
          ...
          <p class="text-gray-400 leading-relaxed">
            Web Developer passionate about creating innovative solutions and building user-friendly applications.
          </p>
          <div class="flex space-x-4">
            ...
            <a href="mailto:sokha.sim@student.passerellesnumeriques.org"
               class="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-gray-700 transition-colors">
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-2 text-gray-400">
            <p>+855 975 911 140</p>
            <p>sokha.sim@student.passerellesnumeriques.org</p>
      ...
      <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
        <p>&copy; {{ currentYear }} Sokha SIM. All rights reserved.</p>
      </div>
    </div>
  </footer>
</template>
